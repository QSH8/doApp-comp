...
<head>
    ...
    <link rel="stylesheet" href="views/style.css"></head>
<body>
    <div>ПРИВЕТ, Я СОЗДАНИЕ ПОЛЬЗОВАТЕЛЯ!</div>
    <form method="post" id="create">
        ...
        <input style="display: block;" type="text" name="password" placeholder="Пароль">
